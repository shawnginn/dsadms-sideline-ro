...
export default function SideLineApp() {
 const [viewMode, setViewMode] = useState<'marketing' | 'login' | 'dashboard'>('dashboard');
 ...
 <h3 className="text-xs font-bold text-cyan-400 uppercase"> Shop Labor Benchmarks</h3>
 <div>
 ...
 {isAdmin && (
 <button onClick={() => { setRectifyingItem(item); setRectifyCount(item.qty); }} className="bg-slate-800 hover:bg-slate-700 text-amber-400 text-[10px] px-2 py-1 rounded border border-slate-700 whitespace-nowrap"> Audit</button>
 )}
 ...
 <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
 <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 max-w-md w-full space-y-4">
 <h3 className="text-sm font-bold text-white uppercase"> Audit & Rectify Physical Stock</h3>
